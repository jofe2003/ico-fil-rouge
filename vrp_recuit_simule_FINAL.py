...
# ── BDD Grande taille (fichiers .xls originaux) ──────────────────────
DATA_DIR = Path(r"C:\Users\gabri\OneDrive\Área de Trabalho\ICO_1\extraido\data_PTV_Fil_rouge")

# ── BDD Petite taille (fichiers .xlsx dans PetitBase) ─────────────────
PETIT_DIR = Path(r"C:\Users\gabri\OneDrive\Área de Trabalho\ICO_1\data_PTV_Fil_rouge\PetitBase")

# Dossier de sortie des résultats
OUT_DIR  = Path(r"C:\Users\gabri\Downloads\VRP_Resultats")
