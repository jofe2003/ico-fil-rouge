...
def load_all_data():
    df_customers   = pd.read_excel("2_detail_table_customers.xls",             engine="xlrd")
    df_vehicles    = pd.read_excel("3_detail_table_vehicles.xls",              engine="xlrd")
    df_depots      = pd.read_excel("4_detail_table_depots.xls",                engine="xlrd")
    df_distances   = pd.read_excel("6_detail_table_cust_depots_distances.xls", engine="xlrd")
    df_constraints = pd.read_excel("5_detail_table_constraints_sdvrp.xls",     engine="xlrd")
    return df_customers, df_vehicles, df_depots, df_distances, df_constraints


def load_petit_data():
    df_customers   = pd.read_excel("petit/2_detail_table_customers_petit.xlsx")
    df_vehicles    = pd.read_excel("petit/3_detail_table_vehicles_petit.xlsx")
    df_depots      = pd.read_excel("petit/4_detail_table_depots_petit.xlsx")
    df_distances   = pd.read_excel("petit/6_detail_table_cust_depots_distance_petit.xlsx")
    df_constraints = pd.read_excel("petit/5_detail_table_constraints_sdvrp_petit.xlsx")
    return df_customers, df_vehicles, df_depots, df_distances, df_constraints
